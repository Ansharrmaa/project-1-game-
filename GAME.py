# Question 1. We all have played snake, water gun game in our childhood. If you haven’t, google the
...
paddle_a.color("ansh shrama shtts xasddssaaaxxsxscscdcdvfgtuulp'['p;oluh    gnhnhtntybb  1y6ku,ilkjbv  ]]")
...
# NEter the nukmber the that u eant to enter in the functoion that is named as ansh sharma 
while True:
    win.update()
